...
<div class="row center-align valign-wrapper">
    <div class="col">
        <h5>Muestra de datos jerarquicos</h5>
    </div>

</div>

<div class="row center-align valign-wrapper" id="row">
    <div class="col s6">
        <div id="map"></div>
    </div>
    <div class="col s6">
...
<script>
    ...
    const svg = d3.select('#map').insert("svg")
