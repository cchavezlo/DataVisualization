d3.csv("http://localhost:1234/static/population.csv", function(err, data) {
  var config = {"color1":"#d3e5ff","color2":"#08306B","nominal": "abbr" ,"stateDataColumn":"state_or_territory","valueDataColumn":"population_estimate_for_july_1_2013_number"}
  ...
  for (var i = 0; i < names.length; i++) {
    ...
    non_value_abbr[names[i].id] = names[i].code;
  }
