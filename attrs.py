attr_data = {
    ...
    "Predecibles": {
        ...
        "PctEmplProfServ": "percentage of people 16 and over who are employed in professional services(numeric - decimal) # No longer sure of difference from PctEmplManu - may include unemployed manufacturing workers ####",
